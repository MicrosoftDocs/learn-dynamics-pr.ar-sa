---
ms.openlocfilehash: 31092ad558e9fc41c8c1dc4fa66f1530f5c8a7f0
ms.sourcegitcommit: bfcf3cb276d50978eba5dd4b8268a26abfd9783a
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 08/17/2021
ms.locfileid: "7436357"
---
...
>[!IMPORTANT]
> قبل أن تبدأ، لتحقيق أقصى تأثير لهذا المعمل والمختبرات الأخرى، من المستحسن أن يكون لديك بعض عينات البيانات للعمل بها. إذا كان المثيل الذي تعمل معه لا يحتوي على أي بيانات نموذجية، يمكنك استخدام الخطوات التالية لإضافة بيانات عينة المخزون إلى نظامك.

1.  في المثيل الذي تستخدمه من Dynamics 365، انتقل إلى **إعدادات** > **إدارة البيانات**.

2.  انقر فوق **عينات البيانات**.

3.  إذا لم يتم تثبيت نموذج البيانات، فانقر فوق **تثبيت نموذج البيانات**. (لاحظ أن ظهور البيانات قد يستغرق بضع دقائق، ولكن يمكنك الاستمرار في استخدام التطبيق أثناء تثبيته.) 
4.  انقر فوق **إغلاق**.
...
يجب إضافة كل نموذج تبيعه إلى Dynamics 365 بحيث يمكن استخدامه لفرص المبيعات والأوامر المستقبلية. من الضروري تحديث كتالوج المنتج لإدراج هذا المنتج الجديد وإتاحته للآخرين.

#### <a name="high-level-steps"></a>الخطوات عالية المستوى

1.  أضف ثلاث طابعات جديدة إلى كتالوج المنتج.
...
السيناريو: أنت تعمل كمسؤول مبيعات لـ Contoso، وتتلقى مكالمة هاتفية من نانسي أندرسون في Adventure Works. إنها مهتمة بالعديد من طابعاتك. من المحتمل أنها تبحث في العناصر التالية:
