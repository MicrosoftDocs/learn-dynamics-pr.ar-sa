...
1. حدد نوع سير العمل من وحدة تطبيقات Finance and Operations من صفحة قائمة **دفتر الأستاذ العام > إعداد دفتر الأستاذ > إنشاء مهام سير عمل دفتر الأستاذ**.
...
محرر سير العمل هو واجهة رسومية يمكنك استخدامها لإنشاء مهام سير عمل تطبيقات Finance and Operations من خلال ترتيب عناصر سير العمل على سطح التصميم.
...
يمكنك استخدام ميزات الترجمات الخاصة بتطبيقات Finance and Operations لترجمة النص إلى لغة مختلفه. تأكد من التحقق من النص الذي تتم ترجمته بواسطة متحدث أصلي.
...
- **المستخدم** - يتيح لك تحديد مستخدمي تطبيقات Finance and Operations محددين. إذا حددت هذا الخيار، حدد علامة التبويب **مستخدم** لاختيار مستخدمي تطبيقات Finance and Operations المناسبين. 
...
بعد الانتهاء من تكوين سير العمل، يمكنك تنشيطه لاستخدامه في تطبيقات Finance and Operations. عندما يكون سير العمل نشطاً، سيتمكن المستخدمون من إرسال المستندات للمعالجة والموافقة. أثناء إنشاء سير العمل، يعرض جزء الأخطاء والتحذيرات ديناميكياً عدد المشكلات التي يجب حلها قبل أن يصبح سير العمل صالحاً. يمكن فقط تنشيط سير عمل صالح.
