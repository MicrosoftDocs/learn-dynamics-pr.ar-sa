---
ms.openlocfilehash: a4a99ad8c464421514838d04d8ab9770de7161a7
ms.sourcegitcommit: c1858cd3b2bd6663edff36e214795d4934ad3ddf
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 09/22/2022
ms.locfileid: "9576467"
---
تتوفر مهام سير العمل عبر العديد من المناطق المختلفة لتطبيقات التمويل والعمليات.

في تطبيقات التمويل والعمليات، يتم تعريف مصطلح سير العمل بطريقتين:
...
يمكنك تحديد ارتباط سير العمل بمؤسستك من خلال قيمة الحقل في صفحة قائمة مهام سير العمل لكل وحدة في تطبيقات التمويل والعمليات، كما هو موضح في الشكل.
...
بعض الوحدات النمطية ليس لديها أي نوع سير العمل على الإطلاق. بدلاً من ذلك، لا يوجد نوع سير العمل الذي تحتاجه للتعامل مع متطلبات عمل معينة. إذا كانت هذه هي الحالة، يمكن لفريق التطوير لديك إنشاء أنواع جديدة لسير العمل في تطبيقات التمويل والعمليات باستخدام Visual Studio.

قبل التخطيط لإنشاء سير عمل جديد، من الأفضل دائماً معرفة ما إذا كان من الممكن استخدام أي مهام سير عمل جاهزة في تطبيقات التمويل والعمليات بدلاً من إنشاء مهمة جديدة.
...
تتوفر عدة أنواع من قوالب سير العمل الجاهزة في تطبيقات التمويل والعمليات.
