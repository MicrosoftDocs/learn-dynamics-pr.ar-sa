---
ms.openlocfilehash: e32e1f9ac89232772d712b37761ea053e73d7555
ms.sourcegitcommit: c1858cd3b2bd6663edff36e214795d4934ad3ddf
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 09/22/2022
ms.locfileid: "9579428"
---
...
4.  في المطالبة **هل تود فتح ReportDesigner.application من usnconeboxax1aos.cloud.onebox.dynamics.com؟** ف في الجزء السفلي من المستعرض، حدد **فتح**.
    > [!NOTE]
    > إذا لم يفتح مصمم التقارير، ولم تتم مطالبتك بتشغيل **Microsoft Dynamics 365 Finance: Financial Report Designer** وتسجيل الدخول، فأعد تشغيل Microsoft Edge في بيئة المعمل، وسجِّل الدخول مرة أخرى، ونفّذ الخطوات من 1 إلى 4 مرة أخرى.
5.  حدد **تشغيل** في مربع **Microsoft Dynamics 365 Finance: Financial Report Designer** لتنزيل "مصمم التقارير". 
6.  استخدم بيانات الاعتماد نفسها لتسجيل الدخول، كما استخدمتها لتسجيل الدخول إلى التمويل والعمليات. قد تظهر نافذة تسجيل الدخول خلف نافذة التمويل والعمليات. سيتم الآن فتح "مصمم التقارير".
6.  قم بتغيير **السنة الأساسية** إلى **2016** وحدد **إنشاء** في أعلى يسار الشاشة. 
7.  ارجع إلى صفحة قائمة **التقارير المالية** في التمويل والعمليات. ستحتاج إلى تحديث الشاشة حتى يظهر التقرير الذي أنشأته.
8.  حدد **طريقة العرض**
...
يمكن عرض التقارير المالية بأي عملة تمت إضافتها إلى تطبيقات التمويل والعمليات.
...
4.  في المطالبة **هل تود فتح ReportDesigner.application من usnconeboxax1aos.cloud.onebox.dynamics.com؟** ف في الجزء السفلي من المستعرض، حدد **فتح**.
    > [!NOTE]
    >إذا لم يفتح "مصمم التقارير"، ولم تتم مطالبتك بتشغيل **Microsoft Dynamics 365 Finance: Financial Report Designer** وتسجيل الدخول، فأعد تشغيل مستعرض الإنترنت في بيئة التمرين العملي، وسجّل مرة أخرى، ثم نفذ الخطوات من 1 إلى 4 مرة أخرى.
5.  حدد **تشغيل** في مربع **Microsoft Dynamics 365 Finance: Financial Report Designer** لتنزيل "مصمم التقارير". 
6.  استخدم بيانات الاعتماد نفسها لتسجيل الدخول، كما استخدمتها لتسجيل الدخول إلى التمويل والعمليات. 
4.  سيُفتح **ملخص ميزان المراجعة – الافتراضي** الآن في "مصمم التقارير".   
5.  حدد **الملف**، ثم **حفظ باسم**، ثم قم بتسمية التقرير **ميزان المراجعة المفصل بالسمات**. في أي وقت يتم إنشاء تقرير جديد في "مصمم التقارير"، يتم تحديث قائمة التقارير المالية في تطبيقات التمويل والعمليات.
6.  من تعريف التقرير، حدد الأيقونة **تعريفات الصف** لفتح تعريف الصف **ميزان المراجعة - الافتراضي**.
...
4.  في المطالبة **هل تريد فتح ReportDesigner.application من usnconeboxax1aos.cloud.onebox.dynamics.com?** في أسفل نافذة المتصفح، حدد **فتح**.
    > [!NOTE]
    >إذا لم يُفتح "مصمم التقارير"، ولم تتم مطالبتك بتشغيل **Microsoft Dynamics 365 Finance: Financial Report Designer** فأعد تشغيل مستعرض الإنترنت، وسجّل الدخول إلى التمويل والعمليات باستخدام بيانات الاعتماد نفسها كما كان من قبل، ونفّذ الخطوات من 1 إلى 4 مرة أخرى.
6.  حدد **تشغيل** في مربع **Microsoft Dynamics 365 Finance: Financial Report Designer** لتنزيل "مصمم التقارير"، و **تشغيل** الملف **ReportDesigner.exe**. 
6.  استخدم بيانات الاعتماد نفسها لتسجيل الدخول، كما استخدمتها لتسجيل الدخول إلى التمويل والعمليات. سيتم الآن فتح "مصمم التقارير" (قد يتم فتحه خلف إطار مستعرض الإنترنت).
...
35. قم بتغيير **السنة الأساسية** إلى **2016**، ثم قم بالـ **حفظ**، ثم حدد **إنشاء**. سيتم فتح شجرة التقارير، وستوفر لك خيار تحديد أيّ من الوحدات أو جميعها. 
36. حدد **تحديد الكل**، ثم حدد **موافق‏‎**.
36. في التمويل والعمليات، قم بتحديث الصفحة حتى تشاهد التقرير الجديد الذي قمت بإنشائه في قسم **التقارير** - قد يستغرق ذلك دقيقتين.
...
4.  في المطالبة **هل تود فتح ReportDesigner.application من usnconeboxax1aos.cloud.onebox.dynamics.com؟** ف في الجزء السفلي من المستعرض، حدد **فتح**.
    > [!NOTE]
    >إذا لم يفتح "مصمم التقارير"، ولم تتم مطالبتك بتشغيل **Microsoft Dynamics 365 Finance: Financial Report Designer** وتسجيل الدخول، فأعد تشغيل مستعرض الإنترنت في بيئة التمرين العملي، وسجّل مرة أخرى، ثم نفذ الخطوات من 1 إلى 4 مرة أخرى.
5.  حدد **تشغيل** في مربع **Microsoft Dynamics 365 Finance: Financial Report Designer** لتنزيل "مصمم التقارير"، و **تشغيل** الملف **ReportDesigner.exe**. 
6.  استخدم بيانات الاعتماد نفسها لتسجيل الدخول، كما استخدمتها لتسجيل الدخول إلى التمويل والعمليات. سيتم الآن فتح "مصمم التقارير".
7.  سيتم فتح تقرير **الميزانية العمومية وبيان الدخل جنبًا إلى جنب - افتراضي** في "مصمم التقارير".
...
10. عندما تُظهر **حالة قائمة انتظار التقارير** أن التقرير **مكتمل**، ارجع إلى التمويل والعمليات وقم بتحديث الصفحة.
11. ابحث عن تقرير **الميزانية العمومية وبيان الدخل المجمعين جنبًا إلى جنب** وافتح التقرير الذي أنشأته للتو.
...
3.  في المطالبة **هل تود فتح ReportDesigner.application من usnconeboxax1aos.cloud.onebox.dynamics.com؟** ف في الجزء السفلي من المستعرض، حدد **فتح**.
    > [!NOTE]
    >إذا لم يفتح "مصمم التقارير"، ولم تتم مطالبتك بتشغيل **Microsoft Dynamics 365 Finance: Financial Report Designer** وتسجيل الدخول، فأعد تشغيل مستعرض الإنترنت في بيئة التمرين العملي، ثم نفّذ الخطوات من 1 إلى 3 مرة أخرى.
5.  حدد **تشغيل** في مربع **Microsoft Dynamics 365 Finance: Financial Report Designer** لتنزيل "مصمم التقارير". 
6.  استخدم بيانات الاعتماد نفسها لتسجيل الدخول، كما استخدمتها لتسجيل الدخول إلى التمويل والعمليات. 
