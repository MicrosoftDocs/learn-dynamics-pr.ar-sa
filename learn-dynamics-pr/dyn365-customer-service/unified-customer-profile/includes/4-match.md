---
ms.openlocfilehash: 79ce932c68dd0fc04f6b899fa8025a1b324f6139
ms.sourcegitcommit: c9e4fdec30906fc4b8686ea5c65b335ca5b68c26
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 12/17/2021
ms.locfileid: "7933278"
---
...
لا يُمكنك إجراء أي مطابقة إلا عند تعيين كيانين على الأقل في أثناء مرحلة التعيين. عند عدم وجود كيانان معينان على الأقل، ستتلقى رسالة للعودة إلى صفحة **الخريطة** وتلبية المتطلبات.
...
1. **المطابقة الأولى** - يُطابق الكيان الأساسي مع الكيان رقم 2.

2. **المطابقة الثانية** - تُطابَق نتائج مجموعة البيانات من المطابقة الأولى مع الكيان رقم 3.

3. **المطابقة الثانية** - تُطابَق نتائج مجموعة البيانات من المطابقة الثانية مع الكيان رقم 4.
...
بعد تحديد ترتيب المطابقة، ستُنقل إلى صفحة **المطابقة**، والتي ستتضمن عمليات المطابقة المحددة. ستجد هذه الصفحة حيثُ يُمكنك الاطلاع على نتائج قواعد المطابقة وستكون فارغة حتى تشغيل أمر مطابقة لاحقاً.
...
- السمة من الكيان الأساسي المطلوب استخدامها للمطابقة من كيان أول زوج مطابقة مثل الاسم أو الهاتف أو عنوان البريد الإلكتروني.

- السمة من الكيان الثانوي، ومن المحتمل أن تكون لديه معلومات مشابهة للحقل المحدد في الكيان الأساسي.
...
يمكن لنفس ملف القالب تحديد سجلات مطابقة مخصصة من كيانات متعددة.
بعد إضافة كافة التجاوزات، قم بحفظ ملف القالب. ويمكنك الانتقال إلى "مصادر البيانات" لاستيعاب ملفات القالب ككيانات جديدة. بعد تحميل الملفات وتوفر الكيانات، حدد خيار التطابق المخصص مرة أخرى. سترى خيارات لتحديد الكيانات التي ترغب في تضمينها. حدد الكيانات المطلوبة من القائمة المنسدلة وحدد تم.
...
رُغم أنه من غير الممكن استخدام أي من وظائف صفحة **المطابقة** حتى تكتمل عملية المطابقة، إلا أنه يُمكنك الانتقال إلى مناطق أخرى من التطبيق من خلال جزء التنقل الأيمن. مثال، يُمكنك استخدام هذا الوقت لتعريف العلاقات أو الأنشطة.
