---
ms.openlocfilehash: 1fdf86c00fbc8fd333448f9802d865870f22d7fa
ms.sourcegitcommit: 17fbeb462233cd883c19109a7033e34b7b5fe01e
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 03/11/2022
ms.locfileid: "8403306"
---
...
إذا فتحت مساحة عمل **محاسبة التكاليف الإدارية** قبل تكوين محاسبة التكاليف، فسترى الصفحة التالية. تتيح لك هذه الصفحة الوصول إلى المعالج.
...
حدد الزر **التالي** لبدء التكوين. حدد كياناً قانونياً من القائمة المنسدلة، ثم حدد **التالي**.
...
يمكنك تحديد التقويم المالي ونوع سعر الصرف وعملة المحاسبة لتكون مختلفة عن تلك القيم التي تم إهمالها من الكيان القانوني المحدد.  تستخدم البيانات من الكيانات القانونية الفردية العملة المحددة ونوع سعر الصرف للتحويل من عملة الكيان القانوني إلى التحديد.

 
> [!div class="mx-imgBorder"]
> ![لقطة شاشة لمعالج بدء محاسبة التكاليف يعرض القيم الافتراضية.](../media/wiz-4.png) 

حدد الأبعاد المالية التي ترغب في تحليلها في دفتر أستاذ محاسبة التكاليف. يجب تحديد عناصر هياكل الحساب فقط المستخدمة بواسطة دفاتر الأستاذ للكيانات القانونية التي تقوم باستيرادها. 
...
يمكنك تحديد بُعد واحد فقط باستخدام المعالج. يجب عليك إنشاء أبعاد أخرى خارج المعالج.
> [!div class="mx-imgBorder"]
...
إذا اخترت تضمين الموازنة، فاترك خيار **إنشاء موصل بيانات الموازنة** إلى **نعم**، ثم حدد **جديد** لتحديد نماذج الموازنة الخاصة بك. يمكنك تضمين بيانات **المصروفات** أو **الإيرادات** وتحديد نوع موازنة. يمكنك أيضاً تحديد كل من الموازنات الأصلية والمعدلة للتحليل. لاحظ أن النظام يستورد بيانات الموازنة المُرحلة فقط. بالنسبة لكل نموذج موازنة، تحتاج إلى تحديد **نوع الموازنة** و **نوع إدخال الموازنة**. 
...
حدد **إنهاء** للسماح للنظام بمعالجة طلبك وإنشاء الكائنات. سيخبرك النظام عند اكتمال المهمة المجمعة، وسيعرض رسالة **التهاني**.

> [!div class="mx-imgBorder"]
> ![لقطة شاشة لمعالج الشروع في عمل محاسبة التكاليف يوضح كيفية عرض رسالة التهاني.](../media/finish.png)
