---
ms.openlocfilehash: f62128b921d3407db46e1316bd4e68f15afebfb0
ms.sourcegitcommit: 6ff9cb62ba54399590302871628170367686827d
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 06/14/2022
ms.locfileid: "9010569"
---
**قامت Contoso بتصنيع الدراجات وبيعها إلى الأفراد والمؤسسات على مدار خمس سنوات. هذا الشهر، طرحت وكالة حكومية محلية عطاءً لتوفير برنامج تأجير دراجات إلكترونية لإحدى العلامات التجارية. ستتناسب Contoso وشركاؤها تمامًا مع مثل هذا المشروع. ستكون بحاجة إلى العمل مع شركائك في Proseware, Inc.، والتي ستوفر قواعد التركيب، ومع Northwind Traders لمعالجة الدفع.**
...
- يطلب أحد كبار العملاء ممن لديه أقسام متعددة تقسيم تمويل مشروع لكل قسم على حدة.
...
في Dynamics 365 Project Operations، يمكنك تقسيم الفواتير لحركة واحدة أو لمشروع بأكمله بين عدة عملاء أو جهات مانحة أو مؤسسات.

تقضي بعض عقود المشروعات بأن يتقاسم العديد من الأطراف المسؤولية فيما يتعلق بتمويل تكاليف المشروع. في إحدى الشركات، قد تحتاج عدة أقسام إلى الحصول على تمويل مشروع، مع تقسيم التمويل بين الأقسام المتعددة المرتبطة بالمشروع. المشروعات التي تساهم فيها العديد من الأطراف في تمويل أحد مشروعات التمويل المتقدم تسمى **مصادر التمويل**. بعد تحديد عميل ما أو مؤسسة أو منحة كمصدر تمويل، يمكن تخصيصها لواحدة أو أكثر من قواعد التمويل. تشمل "قواعد التمويل" المعايير التي تحدد طريقة تخصيص الرسوم لمختلف مصادر التمويل لأي مشروع.

ونظرًا لتعذر تقسيم الأصناف المخزّنة، كتلك التي تظهر في "طلبات الشراء" و"أوامر الشراء"، لا يمكن تقسيم مبلغ التكلفة بين مصادر تمويل متعددة في وقت التوزيع. وعليه، تبقى قيمة مصدر التمويل 0 (صفر) حتى يتم ترحيل صرف المخزون. وعند ترحيل صرف المخزون، يتم توزيع مبلغ التكلفة وفقًا لقواعد توزيع الحساب الخاصة بالمشروع.
