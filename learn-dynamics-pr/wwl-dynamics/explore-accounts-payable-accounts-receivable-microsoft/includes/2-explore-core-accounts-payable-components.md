---
ms.openlocfilehash: 748b4ed4a01c40dfbf4f0f30bb7578bb2d4cdb47
ms.sourcegitcommit: 6d89a68fa258a52927b444de3507785dead574ea
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 06/17/2022
ms.locfileid: "9024541"
---
حسابات المدفوعات هي الأموال المستحقة للمورّدين والتي تظهر كالتزام في الميزانية العمومية للشركة كدين قصير الأجل. فمثلاً، قد يتلقى مطعم ما شحنة طعام قبل دفع ثمن الطعام. هذا الدين جزء من ذممها التجارية الدائنة.
...
لمعرفة المزيد حول إنشاء الموردين، راجع الارتباط المقابل في الوحدة "الملخص والموارد‬" في نهاية هذه الوحدة النمطية.

## <a name="vendor-invoices"></a>فواتير المورّد

لفهم فواتير المورّد، يجب أن تفحص أولاً المكان الملائم لها مع دورات العمل الخاصة بحسابات المدفوعات.
...
عند طلب منتج أو خدمة من أحد الموردين، يجب إنشاء طلبات الشراء وإدخال اتفاقيات الشراء وإدخال أوامر الشراء. ومن ثم، كجُزء من الحسابات الدائنة، يجب الدفع مقابل المنتج أو الخدمة. يتضمن ذلك استلام الفواتير وإدخالها، وإنشاء مدفوعات المورد وإرسالها، وإدارة تسويات الموردين.

يمكنك إدخال فواتير المورّد يدوياً أو استلامها إلكترونياً عن طريق كيان بيانات. عند إنشاء فاتورة، يمكنك أيضاً إرفاق نسخة إلكترونية من الفاتورة بالسجل. بعد إدخال الفواتير أو استلامها، يمكنك مراجعة والفواتير والموافقة عليها باستخدام دفتر يومية الموافقة على الفاتورة أو صفحة "فاتورة المورّد". يمكنك استخدام تطابق الفواتير وسياسات فواتير الموردين وسير العمل لأتمتة عملية المراجعة بحيث تتم الموافقة تلقائياً على الفواتير التي تفي بمعايير معينة، ويتم وضع علامات على الفواتير المتبقية كي تتم مراجعتها بواسطة مستخدم مخول.
...
هناك عدة طرق لإدخال فاتورة المورّد:

- يسمح لك سجل فواتير المورّد بإدخال الفواتير التي لا تشير إلى أمر شراء بسرعة، حتى تتمكن من تجميع المصروفات. وباستخدام دفتر يومية الموافقة على فواتير المورّد، يمكنك تحديد هذه الفواتير وترحيلها إلى رصيد المورّد لإلغاء التجميع.

- في خطوة واحدة، يسمح لك دفتر يومية فواتير المورّد بإدخال الفواتير التي لا تشير إلى أمر شراء بسرعة.

- مع مجموعة فواتير المورّد، يتيح لك سجل فواتير المورّد إدخال الفواتير بسرعة لتجميع المصروفات. ويمكنك فتح أوامر الشراء المرتبطة لاحقًا لترحيل الفاتورة في مقابل حساب المصروفات.
...
أمر الشراء (PO) هو مستند يمثل اتفاقية مع البائع لشراء سلع أو خدمات. يساعد المستند أيضاً في تعقب إيصالات استلام المنتجات المقابلة الأمر، ثم محاسبة فواتير المورّد التي أعدّها المورّد مقابل الأمر.

تحتوي صفحة أوامر الشراء على نظرة عامة على الأوامر المتاحة وتتيح لك تعديل هذه الأوامر. عند فتح أمر شراء، يمكنك تحديد طريقة عرض "الرأس"، والتي تضم المعلومات التي تم تحديدها مرة واحدة فقط لكل أمر شراء، مثل تفاصيل المورد. وبدلاً من ذلك، يمكنك تحديد عرض الخطوط، حيث يمكنك تعديل بنود الأوامر. ستقوم عادة بالتبديل بين هذين العرضين أثناء تعديل أوامر الشراء. لا يتم سرد الرسوم مباشرة في صفحة "أوامر الشراء"، ولكن يمكن الوصول إليها عبر القوائم الموجودة في رأس الطلب والبنود.
...
تتيح لك مساحات عمل إعداد "أمر الشراء" وإيصال "أمر الشراء" والمتابعة عرض قوائم أوامر الشراء في الحالات المختلفة التي تقدموا إليها. كما أنها توفر ملخصًا للإجراءات التي يجب اتخاذها. تركز مساحة عمل إعداد "أمر الشراء" على إنشاء أمر الشراء ومراجعته ومعالجة الأمر من خلال الموافقة والتأكيد مع المورد. تركز مساحة عمل استلام "أمر الشراء" والمتابعة على معالجة استلام البضائع أو الخدمات مقابل أوامر الشراء. إنها تتضمّن القوائم التي تقدم تفاصيل حول الإيصالات المتأخرة أو التي سيستحق تسليمها من قبل المورّد في وقت قريب. لا يتم استخدام مساحات العمل هذه لأداء أنشطة الاستلام ذات الصلة التي تم تنفيذها داخل المستودع. تجري هذه الأنشطة باستخدام الصفحات داخل الوحدات النمطية لإدارة المخزون و"إدارة المستودع". يلزم معالجة فواتير المورد باستخدام مساحة عمل إدخال فاتورة المورد، ويجب أن تتم المدفوعات باستخدام مساحة عمل مدفوعات المورد.

لمعرفة المزيد حول المراحل المختلفة التي يمر بها "أمر الشراء"، انتقل إلى الارتباطات المقابلة في الوحدة "الملخص والموارد" في نهاية هذه الوحدة النمطية.
...
2. تقوم أبريل وهي منسقة حسابات المدفوعات في شركة Fabrikam، بإدخال الفاتورة المقدّمة من قبل Contoso والتحقق منها. تتحقق أبريل من المعلومات التالية:
    ...
    - وبالنسبة للأصناف التي تتطلب تطابقًا ثنائي أو ثلاثي الاتجاه، تقع الأسعار في بند الفاتورة ضمن التفاوتات المحددة داخل التطبيق. ويشمل ذلك الأنواع التالية من تطابق السعر:
        ...
        - **مطابقة صافي سعر الوحدة** – يتطابق صافي سعر الوحدة في بند الفاتورة مع صافي سعر الوحدة في بند أمر الشراء، ضمن النسبة المئوية للتفاوت. في ذلك المثال، يمثل تفاوت صافي سعر الوحدة +2%.

        - **مطابقة إجماليات الأسعار** – يتطابق المبلغ الصافي في بند الفاتورة مع المبلغ الصافي في بند أمر الشراء، ضمن النسبة المئوية للتفاوت أو المبلغ أو النسبة المئوية والمبلغ. في هذا المثال، يمثل إجمالي الأسعار المطابق للتفاوت أكثر من 10%.
...
> لمعرفة المزيد حول سياسات المطابقة الثلاثية، راجع الارتباط المقابل في الوحدة "الملخص والموارد" في نهاية هذه الوحدة النمطية.
