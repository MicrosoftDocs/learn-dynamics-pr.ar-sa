---
ms.openlocfilehash: cbe8be057b7e13be0e0466cf2efc7139a42eb666
ms.sourcegitcommit: 85778b3076a453a43a600b3490283993430edcfb
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 09/16/2021
ms.locfileid: "7496705"
---
...
تعمل التمارين والتدريبات العملية في هذه الوحدة النمطية بشكل أفضل إذا توفرت لديك عينة بيانات للعمل معها. إذا لم تتضمن البيئة الخاصة بك عينة البيانات، فراجع [دليل مستخدم Dynamics 365 Field Service](/dynamics365/field-service/user-guide?azure-portal=true).
...
4.  حدد موقع عنصر غير مجدول على الخريطة. (سيظهر مع علامة تعجب باللون الأحمر) اسحب الصنف لفتح الفترة الزمنية في جدول أليسون ديكسون قبل أمر العمل الذي قمت بجدولته لها مسبقاً. لاحظ أنه تم إنشاء حجز، وتم تغيير المتطلب إلى لون تثبيت أليسون.
...
3.  حدد موقع أمر العمل المروحة لا تعمل المعين إلى Joseph Gonsalves.
4.  **انقر بزر الماوس الأيمن فوق** أمر العمل، ومن القائمة التي تظهر، حدد **‏‫إعادة الحجز‬**.
5.  سيتم فتح **مساعد الجدولة**. يجب أن يتم تقديم ما بين 4 و7 موارد متوفرة لديك.
6.  حدد كتلة التوافر للمورد Efrain Schreiner. في شاشة **إنشاء حجز المورد** اقبل الإعدادات الافتراضية وانقر فوق **إعادة الحجز وإغلاق**.
7.  حدد موقع أمر العمل فشل تمهيد القرص الثابت المعين للمورد Joseph Gonsalves.
...
10. قم بتمرير مؤشر الماوس فوق كتلة التوافر التي تظهر للمورد Simon Raley. انقر فوق **بديل**.
11. سيتم إعادة تعيين الحجز من Joseph إلى Simon.
