...
## <a name="enable-bing-maps-to-use-with-resource-scheduling"></a>تمكين خرائط Bing لاستخدامها مع Resource Scheduling
...
1. باستخدام منطقة التنقل إلى اليمين، حدد منطقة **جدولة الموارد** في أسفل الشاشة. من القائمة التي تظهر، حدد **الإعدادات**.
...
قبل أن تتمكن من بدء جدولة العناصر وتعيينها لموارد محددة في مؤسستك، تحتاج أولاً إلى إنشاء موارد قابلة للحجز في التطبيق. يمكن أن يكون المورد القابل للحجز مستخدماً داخلياً أو جهة اتصال خارجية أو حساباً أو قطعة من المعدات. عندما تحدد مورداً قابلاً للحجز، يمكنك أيضاً تقديم تفاصيل مثل المهارات التي يمتلكها، وأين يبدأ يومه وأين ينتهي وما إلى ذلك.
...
1. حدد علامة التبويب **جدولة**، وقم بتكوينها على النحو التالي:
...
1. حدد علامة التبويب **خدمة ميدانية** وقم بتكوينها على النحو التالي:
...
بشكل افتراضي، يكون كيان أمر العمل في Dynamics 365 for Field Service ممكّناً لاستخدامه مع ميزة جدولة الموارد. في هذه المهمة، سنقوم بإنشاء أمر عمل جديد يمكننا جدولته باستخدام التطبيق.
...
1. باستخدام منطقة التنقل إلى اليمين، حدد **أوامر العمل**.
...
1. حدد علامة التبويب **إعدادات**، وقم بتكوين الإعدادات كما يلي:
    ...
    - **وقت بدء التعهد**: اليوم عند الساعة 1:00 من بعد الظهر

    - **وقت انتهاء التعهد**: اليوم عند الساعة 3:00 من بعد الظهر
...
1. باستخدام منطقة التنقل إلى اليمين، حدد **لوحة الجدولة**.
...
1. حدد موقع أمر عمل **Adventure Works (عينة)** الذي أنشأته في مهمة سابقة وحدده. اسحبه إلى Allison Dickson على لوحة الجدولة. لاحظ أن النص يظهر باللون الأحمر حتى تعثر على وقت يقع ضمن النافذة الزمنية الموعودة.
...
1. حدد موقع أمر عمل **Fourth Coffee (عينة)** ضمن **أوامر العمل غير المجدولة** وحدده. حدد **بحث عن التوافر**.
