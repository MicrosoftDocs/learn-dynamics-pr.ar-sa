---
ms.openlocfilehash: ed2f618009ebaefe256ab3d0c4033299ad75c975
ms.sourcegitcommit: 1b9d23cafd682a07d083297f4d83426c6bdee67c
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 12/02/2021
ms.locfileid: "7880204"
---
...
عندما يتم إنشاء صنف يلزم جدولته، كأمر عمل في Dynamics 365، فإنه يتضمن عادةً معلومات ستؤثر في كيفية جدولته بما في ذلك الموقع والمهارات والإطار الزمني والتفضيلات. بعد إنشاء سجل أمر عمل، يتم إنشاء سجل متطلبات المَورد تلقائياً.
عندما تقوم بجدولة عنصر، لا تتم جدولة أمر العمل؛ بدلاً من ذلك، هو سجل متطلبات المورد الذي يتم استخدامه بواسطة Universal Resource Scheduling الذي تتم جدولته.
متطلب المورد يحدد المعلومات المعينة المطلوبة للصنف الذي ستتم جدولته.
...
قم بتوسيع **لوحات المتطلبات**، أدخل عنواناً، وحدد العرض الذي قمت بإنشائه، وحدد علامة الجمع (**+**) أيقونة، ثم حدد **تطبيق**.
