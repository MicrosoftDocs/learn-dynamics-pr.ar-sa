---
ms.openlocfilehash: ece1b1f4a56e5ad51d54d236cebdd280c5c5cdf1
ms.sourcegitcommit: d028bd45fcfeb41ac5db1f0d66db059a81c77276
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 03/08/2022
ms.locfileid: "8397782"
---
...
يتم تقييم نُهُج إدارة المصروفات قبل السماح بتقديم تقرير المصروفات أو اعتماده. يتم تقييم نُهُج التدقيق لتقارير المصروفات المكتملة بالفعل. يمكن لنُهُج التدقيق أيضاً وضع علامة على المخالفات التي تنطبق على مجموعات تقارير المصروفات استناداً إلى نطاقات التواريخ أو الموظفين أو المعايير الأخرى.
 
لتكوين نُهُج التدقيق، انتقل إلى **‏‫منضدة عمل التدقيق** > **إعداد**  > **النُهُج** > **تقرير المصروفات**. 

عند إنشاء نهج جديد، تحتاج إلى تحديد:

- المؤسسات التي تنطبق عليها القاعدة 
- قواعد السياسات

يمكنك تحديد تفاصيل نهج التدقيق عن طريق تحديد اسم النهج.
...
ويستخدم كل نوع قاعدة ترتيب الأسبقية التي تحددها في علامة التبويب **معلمات قاعدة النهج** في صفحة **المعلمات**. لتكوين ترتيب الأسبقية لقواعد التدقيق، انتقل إلى **‏‫منضدة عمل التدقيق‬ > نُهُج التدقيق > المعلمات** في صفحة **نُهُج التدقيق**.
...
|--------------------------------|---------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     **اسم القاعدة**                  |     اسم النهج - يمكن أن يصل إلى مائة حرف                                                                  |     يمكنك تسمية قواعد النهج كيفما تشاء.                                                                                                                                             |
|     **الوصف‏‎**                |     ما يصل إلى خمسمائة حرف من النص الوصفي                                                                         |     يمكنك تضمين وصف لقاعدة النهج بعبارات سهلة الفهم.                                                                                                               |
...
|     **نوع المستند**             |     للقراءة فقط - الجدول الأساسي المستخدم بواسطة الاستعلام الذي تحدده                                                                    |     هذا هو نوع المستند الذي يقوم النهج بتدقيقه. وهو الاسم المألوف للجدول المستخدم في الاستعلام.                                                                                 |
...
هناك العديد من أنواع الاستعلام المستخدمة لأنواع قواعد نهج التدقيق. 

### <a name="conditional"></a>شرطي
لا يضيف نوع الاستعلام الشرطي أي معايير إلى الاستعلام علاوة على ما يتم تحديده كعامل تصفية لقاعدة نهج التدقيق. 

### <a name="aggregate"></a>تجميعي
يتضمن نوع الاستعلام التجميعي العبارتين GROUP BY وHAVING في الاستعلام. على سبيل المثال، إذا كنت ترغب في تشجيع الموظفين على متابعة حياتهم المهنية واجتياز اختبارات الشهادات الاحترافية. تريد تحديد المبلغ الذي ستدفعه للموظف خلال عام.

لا تؤدي القاعدة المحددة في لقطة الشاشة أدناه إلى حدوث انتهاك ما لم ينفق الموظف الخاضع للتدقيق أكثر من 1,000 دولار أمريكي في السنة مقابل اختبارات الشهادات الاحترافية.

> [!div class="mx-imgBorder"]
> [ ![ لقطة شاشة لسطر تقرير التصدير تظهر فئة المصروفات.](../media/expense-report-lines-category.png)](../media/expense-report-lines-category.png#lightbox)


> [!div class="mx-imgBorder"]
> [ ![ لقطة شاشة لسطر تقرير التصدير تظهر المعايير أعلى من 1000.](../media/expense-report-lines.png)](../media/expense-report-lines.png#lightbox)
...
يمكنك تطبيق معيار على أي عمود من سطر المصروفات ليؤدي هذا إلى تحديد السطر لإجراء التدقيق. في المثال التالي، سيتم تحديد خمسين بالمائة من سطور المصروفات التي يكون مبلغ الحركة بها >1000 للمراجعة.
...
تقوم الاستعلامات المكررة بالبحث عن سطور المصروفات المتكررة التي تحدث خلال عدد محدد من الأيام. يمكنك تحديد عدد الأيام السابقة لتاريخ البدء المطلوب تضمينه في التدقيق عند البحث عن التكرارات. يؤدي تحديد صفر لأيام إضافية إلى أن يبحث التدقيق فقط في سطور المصروفات ضمن نطاق تاريخ الدُفعة.
...
البحث بالكلمة الأساسية مرن جداً. يمكنك البحث في أي عدد من أعمدة البيانات المتاحة وتضمين عدد غير محدود من كلمات البحث. 
 
عند إضافة نوع قاعدة نهج تدقيق إلى نهج تدقيق، يجب عليك تحديد المعايير التالية بغض النظر عن نوع الاستعلام:

- **تاريخ السريان** و **تاريخ انتهاء الصلاحية** – يمكن أن تحد هذه التواريخ من السجلات التي تم البحث عنها في الدفعة. على سبيل المثال، قد تحدد القاعدة فترة محظورة للسفر لشهر معين. يجب عليك إدخال تاريخي البدء والانتهاء للشهر المحظور هنا.
- **عامل التصفية** – حدد أي قيم تصفية مسموح بها للمستند (تقرير المصروفات أو سطر المصروفات) الذي يتم تدقيقه.

## <a name="testing-an-audit-policy-rule"></a>اختبار قاعدة نهج التدقيق
...
لتقييم قاعدة النهج، قم بإنشاء دفعة تحدد نطاق التاريخ للمستندات لمراجعتها. أرسل الدفعة باستخدام عنصر القائمة **خيارات إضافية** في صفحة **نهج التدقيق** أو **تفاصيل نهج التدقيق**.
...
عند إرسال إحدى الدفعات، يتم تقييم كافة تقارير المصروفات التي تفي بنطاق التاريخ المحدد مقابل كافة أنواع القواعد المحددة في قاعدة نهج التدقيق. تعمل النتائج الخاصة بكل نوع من أنواع قواعد النهج ضمن نهج التدقيق على إنشاء حالة تدقيق.
...
تقوم الحالة بتجميع تقارير أو سطور المصروفات التي بها مخالفة إذا كانت الحالة نشطة. على سبيل المثال، يمكن عرض تقرير المصروفات الذي ينتهك تعويض 1,000 دولار أمريكي/سنة من الأميال. يوجد اقتران مع العامل وتقرير المصروفات الفعلي. 

## <a name="grouping-cases"></a>تجميع الحالات
