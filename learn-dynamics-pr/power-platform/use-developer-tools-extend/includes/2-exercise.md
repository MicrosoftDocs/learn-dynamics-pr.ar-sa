---
ms.openlocfilehash: f26304808b2a5dd7ebaa00d9c839d64f78e6bef2
ms.sourcegitcommit: 8594c8c897c84afee64be07d76b49d8e1ed405e1
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 05/19/2022
ms.locfileid: "8771663"
---
في هذا التمرين، ستقوم بتثبيت بعض أدوات المطور من NuGet.

> [!IMPORTANT]
> استخدم بيئة اختبار مع توفير Microsoft Dataverse. وإذا لم يتوفر لديك، فيمكنك الاشتراك في [خطة المجتمع](https://powerapps.microsoft.com/communityplan/?azure-portal=true).
...
1.  في قائمة "بدء تشغيل Windows"، اكتب **Windows PowerShell** وافتحه.
...
عند إنشاء المكون الإضافي المخصص الخاص بك، ستستخدم هذه الأداة لتحميل التجميع وتسجيل الخطوات للأحداث التي تريد معالجتها.
