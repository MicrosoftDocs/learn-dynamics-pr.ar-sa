...
يتم كل الوصول إلى Dataverse في سياق مستخدم مسجل الدخول. يمكن أن يكون هذا مستخدماً تفاعلياً عادياً أو مستخدماً غير تفاعلي باستخدام مصادقة خادم إلى خادم (S2S).
...
يجب أن يكون لديك الآن تطبيق مسجل يمكنه الاتصال ببيئة Dataverse الخاصة بك بنجاح. لديك أيضاً مثال بسيط للاتصال واستخدام التطبيق المسجل للوصول إلى عملية واجهة API للويب.
