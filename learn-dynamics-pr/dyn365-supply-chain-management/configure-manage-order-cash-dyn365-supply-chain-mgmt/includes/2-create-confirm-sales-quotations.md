---
ms.openlocfilehash: a3f7df2b3855dcdf3e2653f7b3e812809bf42bae
ms.sourcegitcommit: 11bef0429a06db7e1b44fd02f21fc8cb985a2910
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 12/21/2021
ms.locfileid: "7944366"
---
...
-   **عميل نوع عرض الأسعار** - يشير هذا الحقل إلى جدول إعداد **النوع** الذي تم شرحه سابقاً. يمكن أن يكون نوع عرض الأسعار افتراضياً عند إنشاء عرض أسعار مبيعات.
...
-  **تخطي البيانات المشار إليها في عرض أسعار المبيعات أثناء تعقب التغييرات** - يسمح لك بتحديد ما إذا كانت التغييرات في البيانات المشار إليها بواسطة عروض الأسعار مضمنة في تصدير تزايدي. إذا اخترت عدم تضمين عروض الأسعار أو البنود هذه، فسيتم تشغيل عمليات التصدير المتزايدة بسرعة أكبر. 
    ...
    للوصول إلى البيانات المرجعية **تخطي عرض أسعار المبيعات أثناء تتبع التغيير** يجب تمكين **سياسة تصدير البيانات المشار إليها في عرض أسعار المبيعات** في **إدارة الميزات**. عند تمكينه، يمكن العثور عليه في صفحة **معلمات الحسابات المدينة** ضمن علامة التبويب **عام** و **إعداد تصدير كيان البيانات** علامة تبويب سريعة كما هو موضح في الصورة التالية. 

    [![لقطة شاشة للبيانات المشار إليها في "تخطي عرض أسعار المبيعات" أثناء معلمة تتبع التغيير.](../media/data-entity-export-setup-ss.png)](../media/data-entity-export-setup-ss.png#lightbox)
