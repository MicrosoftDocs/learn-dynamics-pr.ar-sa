...
يمكنك إنشاء أمر مبيعات جديد بالانتقال إلى **الحسابات المدينة > أوامر المبيعات > جميع أوامر المبيعات** ثم حدد **جديد** في جزء الإجراءات. بالإضافة إلى ذلك، يمكنك أيضاً إنشاء أوامر مبيعات عن طريق تأكيد عرض أسعار مبيعات في الوحدة النمطية الخاصة بالمبيعات والتسويق. عند تأكيد عرض أسعار المبيعات، يتم إنشاء أمر مبيعات تلقائياً. 
