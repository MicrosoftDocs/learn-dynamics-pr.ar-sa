...
تعد مجموعات نماذج الصنف جزءاً مهماً من تكوين منتج للمخزون وإدارة المخزون والحسابات. تحتوي مجموعات نماذج الأصناف على إعدادات تحدد كيفية التحكم في الأصناف ومعالجتها عند استلامها وإصدارها.
