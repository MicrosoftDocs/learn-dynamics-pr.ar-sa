---
ms.openlocfilehash: 495de893d94eaaeb22d530e850a82d727148c135
ms.sourcegitcommit: 32fba769d30f707adde8f3b6160e3c105e74f43e
ms.translationtype: HT
ms.contentlocale: ar-SA
ms.lasthandoff: 02/28/2022
ms.locfileid: "8360127"
---
...
تتضمن أوامر الشراء خيارًا لإرسال استعلام شراء إلى المورد كبديل لطلب أكثر شمولاً لعملية عرض الأسعار. يمكن استخدام استعلام الشراء للمساعدة في تحديد شروط، مثل الأسعار والخصومات وتاريخ التسليم للأمر. إذا تم إعداد الموردين لاستخدام تعاون المورد، فسيتم تعطيل وظيفة استعلام الشراء. بدلاً من ذلك، تتم مشاركة الأمر على واجهة تعاون المورد، وعندما يتم إرسال أمر شراء، يمكن للمورد تأكيد الأمر مباشرةً.
...
يعبر الطلب الذي يضم غرض الاستهلاك عن طلب للأصناف أو الخدمات التي ستستخدمها مؤسستك داخلياً. يتم دائماً الوفاء بالطلب الذي تم إنشاؤه بواسطة هذا النوع من الطلبات من خلال أمر الشراء. إذا تم إعداد Supply Chain Management لإنشاء أوامر الشراء تلقائيًا، فسيتم إنشاء أوامر الشراء بعد الموافقة على طلب الشراء.
...
لاستخدام طلبات الشراء التي تضم غرض التزويد، يجب عليك إعداد جدولة رئيسية لتضمين الطلب. يتم بعد ذلك تحديد أسلوب الاستيفاء للطلب الذي تم إنشاؤه بواسطة هذا النوع من الطلبات تلقائيًا، استناداً إلى نُهج التوريد التي تم إعدادها للأصناف في مؤسستك والمخطط لها باستخدام الجدولة الرئيسية.
...
على سبيل المثال، إذا كانت الاتفاقية مرتبطة بطلب شراء، فعند الموافقة على طلب الشراء وإنشاء أمر الشراء، سيحتوي أمر الشراء على ارتباط باتفاقية الشراء تلقائيًا.
